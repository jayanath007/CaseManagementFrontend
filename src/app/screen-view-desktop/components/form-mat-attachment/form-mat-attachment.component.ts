...
import { InfoDialogType, checkUploadFileIsBlacklisted, showInforDialog } from './../../../core/utility/DpsUtility';
...
@Component({
  selector: 'dps-form-mat-attachment',
  styleUrls: ['./form-mat-attachment.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './form-mat-attachment.component.html',
})
export class FormMatAttachmentComponent extends EditorControl implements Field, AfterViewInit {
    ...
    this.popupService.openDrivePopup(null, null).subscribe((val: any[]) => {
      ...
      if (attachement && attachement.length > 0) {
        ...
        return this.eventOutput.emit({
          value: value,
          type: ScreenDesignFormActions.MatAttachmentUpload,
