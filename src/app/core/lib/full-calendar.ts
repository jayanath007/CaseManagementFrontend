...
export interface AgendaOptions {
     ...
     * Also affects the granularity at which `selections` can be made.
     */
...
export interface ClickingAndHoveringOptions {
     ...
     */
    dayClick?(date: any, jsEvent: MouseEvent, view: ViewObject): void;
...
export interface EventObject extends Timespan {
    ...
    borderColor?: string;
    textColor?: string;
    /* non-standard fields, see https://fullcalendar.io/docs/event_data/Event_Object/ and
