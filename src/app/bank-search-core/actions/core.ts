...
export type Any = InitPage | LoadFeeEarnerList | LoadFeeEarnerListSuccess | LoadFeeEarnerListFail |
    ...
    EChitAuthoriseSaveSuccess | EChitAuthoriseSaveFail | SelectedRowChange | CheckBoxChange |
