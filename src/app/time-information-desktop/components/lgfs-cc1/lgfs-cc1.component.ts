...
@Component({
  selector: 'dps-lgfs-cc1',
  templateUrl: './lgfs-cc1.component.html',
  styleUrls: ['./lgfs-cc1.component.scss']
})
export class LgfsCc1Component implements OnInit, OnChanges, OnDestroy {
