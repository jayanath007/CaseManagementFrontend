...
@Component({
  selector: 'dps-proceedings-rc1',
  templateUrl: './proceedings-rc1.component.html',
  styleUrls: ['./proceedings-rc1.component.scss']
})
export class ProceedingsRc1Component implements OnInit, OnChanges, OnDestroy {
      ...
      .subscribe((values) => {
        ...
        if (values[0] && JSON.stringify(values[0]) !== JSON.stringify(values[1])) {
          ...
          if ((
            ...
            previesValue.attendance !== curentValues.prep ||
