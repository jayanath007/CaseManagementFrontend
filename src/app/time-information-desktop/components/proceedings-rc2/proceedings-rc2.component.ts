...
@Component({
  selector: 'dps-proceedings-rc2',
  templateUrl: './proceedings-rc2.component.html',
  styleUrls: ['./proceedings-rc2.component.scss']
})
export class ProceedingsRc2Component implements OnInit, OnChanges, OnDestroy {
