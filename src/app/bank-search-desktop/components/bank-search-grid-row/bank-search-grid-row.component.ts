...
@Component({
  selector: 'dps-bank-search-grid-row',
  templateUrl: './bank-search-grid-row.component.html',
  styleUrls: ['./bank-search-grid-row.component.scss']
})
export class BankSearchGridRowComponent implements OnInit {
