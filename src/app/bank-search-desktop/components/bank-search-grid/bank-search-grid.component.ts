...
@Component({
  selector: 'dps-bank-search-grid',
  templateUrl: './bank-search-grid.component.html',
  styleUrls: ['./bank-search-grid.component.scss']
})
export class BankSearchGridComponent implements OnInit {
