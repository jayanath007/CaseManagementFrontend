...
@Component({
  selector: 'dps-bank-search-layout',
  templateUrl: './bank-search-layout.component.html',
  styleUrls: ['./bank-search-layout.component.scss']
})
export class BankSearchLayoutComponent implements OnInit {
  ...
  onBankDetailsSearch(event) {

  }
  onBankDetailsKeypress(event) {
