import {
  Component, OnInit, Input, Output, ViewChild, ElementRef, QueryList, EventEmitter,
  Inject, ChangeDetectorRef, OnDestroy, AfterViewInit, ChangeDetectionStrategy, forwardRef
} from '@angular/core';
...
export class SelectSearchComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  @Input() noEntriesFoundLabel = 'No Data';

  @Input() hiddenEmptyValue = false;
