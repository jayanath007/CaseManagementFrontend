...
@Component({
  selector: 'dps-file-history-two-group',
  templateUrl: './file-history-two-group.component.html',
  styleUrls: ['./file-history-two-group.component.scss']
})
export class FileHistoryTwoGroupComponent implements OnInit {
